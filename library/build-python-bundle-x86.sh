...
test -f "$SRC/usr/lib/python3.14/site-packages/certifi/__init__.py"
test -f "$SRC/usr/lib/python3.14/site-packages/certifi/core.py"
...
unzip -l "$OUT" | grep 'usr/lib/python3.14/site-packages/certifi/__init__.py$'
unzip -l "$OUT" | grep 'usr/lib/python3.14/site-packages/certifi/core.py$'
